...
public class MobileSearchServiceImpl implements MobileSearchService {
	...
	public Map<String, Object> selectKnowledgeByTagsAndkeywords(Long userid, String keywords, String scope, String tag, int page, int size) {
		...
		int count = mobileKnowledgeMapper.selectCountKnowledgeByTagsAndKeyWords(userid, tag, keywords);
		List<?> kcl = mobileKnowledgeMapper.selectKnowledgeByTagsAndKeyWords(userid, tag, keywords, start, size);
	...
	public Map<String, Object> selectKnowledgeByMyCollectionAndkeywords(Long userid, String keywords, String scope, int page, int size) {
		...
		/** 判断是否传的是默认值 */
		start = start < 0 ? 0 : start;
		int count = mobileKnowledgeMapper.selectCountKnowledgeByMyCollectionAndKeyWords(userid, keywords);
		List<?> kcl = mobileKnowledgeMapper.selectKnowledgeByMyCollectionAndKeyWords(userid, keywords, start, size);
		PageUtil p = new PageUtil(count, page, size);
		Map<String, Object> m = new HashMap<String, Object>();
		m.put("page", p);
		m.put("list", kcl);
	...
	// 已作废
	@Override
	public Map<String, Object> selectShareMeByKeywords(Long userid, String keywords, String scope, int start, int size) {
	...
	public Map<String, Object> selectKnowledgeBySourceAndColumn(Long userid, long columnId, String scope, int page, int size) {
		logger.info("com.ginkgocap.ywxt.knowledge.service.impl.MobileSearchService.selectKnowledgeBySourceAndColumn:{},", userid);
		logger.info("com.ginkgocap.ywxt.knowledge.service.impl.MobileSearchService.selectKnowledgeBySourceAndColumn:{},", columnId);
		logger.info("com.ginkgocap.ywxt.knowledge.service.impl.MobileSearchService.selectKnowledgeBySourceAndColumn:{},", scope);
		logger.info("com.ginkgocap.ywxt.knowledge.service.impl.MobileSearchService.selectKnowledgeBySourceAndColumn:{},", page);
		logger.info("com.ginkgocap.ywxt.knowledge.service.impl.MobileSearchService.selectKnowledgeBySourceAndColumn:{},", size);
		int start = (page - 1) * size;
		/** 判断是否传的是默认值 */
		start = start < 0 ? 0 : start;
		int count = mobileKnowledgeMapper.selectCountKnowledgeBySourceAndColumn(columnId, userid);
		List<?> kcl = mobileKnowledgeMapper.selectKnowledgeBySourceAndColumn(columnId, userid, start, size);
		PageUtil p = new PageUtil(count, page, size);
		Map<String, Object> m = new HashMap<String, Object>();
		m.put("page", p);
		m.put("list", kcl);
	...
	// 已作废
	@Override
	public Map<String, Object> selectMyFriendKnowledgeByKeywords(String friends, long columnId, String scope, int page, int size) {
		logger.info("com.ginkgocap.ywxt.knowledge.service.impl.MobileSearchService.selectMyFriendKnowledgeByKeywords:{},", columnId);
		logger.info("com.ginkgocap.ywxt.knowledge.service.impl.MobileSearchService.selectMyFriendKnowledgeByKeywords:{},", friends);
		logger.info("com.ginkgocap.ywxt.knowledge.service.impl.MobileSearchService.selectMyFriendKnowledgeByKeywords:{},", scope);
		logger.info("com.ginkgocap.ywxt.knowledge.service.impl.MobileSearchService.selectMyFriendKnowledgeByKeywords:{},", page);
		logger.info("com.ginkgocap.ywxt.knowledge.service.impl.MobileSearchService.selectMyFriendKnowledgeByKeywords:{},", size);
		int start = (page - 1) * size;
		/** 判断是否传的是默认值 */
		start = start < 0 ? 0 : start;
		/** 临时数组 */
		...
		int count = mobileKnowledgeMapper.selectCountForMyFriendKnowledgeByKeyWords(tempFriends, columnId);
		List<?> kcl = mobileKnowledgeMapper.selectMyFriendKnowledgeByKeyWords(tempFriends, columnId, start, size);
		PageUtil p = new PageUtil(count, page, size);
		Map<String, Object> m = new HashMap<String, Object>();
		m.put("page", p);
		m.put("list", kcl);
	...
	public Map<String, Object> selectknowledgeByColumnIdAndSource(long columnId, long source, String scope, int page, int size) {
		...
		int start = (page - 1) * size;
		int count = mobileKnowledgeMapper.selectCountKnowledgeForSourceByColumn(columnId, source);
		List<?> kcl = mobileKnowledgeMapper.selectKnowledgeForSourceByColumn(columnId, source, start, size);
		PageUtil p = new PageUtil(count, page, size);
		Map<String, Object> m = new HashMap<String, Object>();
		m.put("page", p);
		m.put("list", kcl);
	...
	public Map<String, Object> selectMyFriendknowledgeByColumnId(long columnId, long userId, String scope, int page, int size) {
		...
		int start = (page - 1) * size;
		/** 判断是否传的是默认值 */
		int count = mobileKnowledgeMapper.selectCountForMyFriendKnowledgeByColumnId(columnId, userId);
		List<?> kcl = mobileKnowledgeMapper.selectMyFriendKnowledgeByColumnId(columnId, userId, start, size);
		PageUtil p = new PageUtil(count, page, size);
		Map<String, Object> m = new HashMap<String, Object>();
		m.put("page", p);
		m.put("list", kcl);
	...
	public Map<String, Object> selectAllKnowledge(Long userid, String keywords, int page, int size) {
		...
		logger.info("com.ginkgocap.ywxt.knowledge.service.impl.MobileSearchService.selectAllKnowledge:{},", userid);
		logger.info("com.ginkgocap.ywxt.knowledge.service.impl.MobileSearchService.selectAllKnowledge:{},", keywords);
		logger.info("com.ginkgocap.ywxt.knowledge.service.impl.MobileSearchService.selectAllKnowledge:{},", page);
		logger.info("com.ginkgocap.ywxt.knowledge.service.impl.MobileSearchService.selectAllKnowledge:{},", size);
		int start = (page - 1) * size;
		/** 判断是否传的是默认值 */
		start = start < 0 ? 0 : start;
	 ...
	 * 
	 * @see
	 * com.ginkgocap.ywxt.knowledge.service.MobileSearchService#selectCountKnowledge
	 * (long) Administrator
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.ginkgocap.ywxt.knowledge.service.MobileSearchService#countPush(java
	 * .lang.Long, java.lang.String, java.lang.String) Administrator
	 */
	@Override
	public int countPush(Long userid, String tag, String keywords) {

		return mobileKnowledgeMapper.selectCountKnowledgeByTagsAndKeyWords(userid, tag, keywords);
	}
}
