...
@Repository("knowledgeMongoDaoV1")
public class KnowledgeMongoDaoImplV1 implements KnowledgeMongoDaoV1 {

    private Logger logger = LoggerFactory.getLogger(KnowledgeMongoDaoImplV1.class);
	@Resource
