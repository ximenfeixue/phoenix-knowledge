...
public class UserPermissionDAOImpl extends SqlMapClientDaoSupport implements UserPermissionDAO {
    ...
    @Override
    public void insertUserPermission(long[] receive_uid, long knowledgeid, long send_uid, int type, String mento,
            long column_id) {
        ...
        getSqlMapClientTemplate().insert("tb_user_permission.batchInsert", list);
    }
    ...
    public int deleteUserPermission(long[] knowledgeids, long userid) {
        ...
        int count = getSqlMapClientTemplate().delete("tb_user_permission.delete", map);
