...
public interface KnowledgeCategoryValueMapper {
    ...
    //导入导出
    List selectKnowledgeId(@Param("userId") long userId, @Param("groupid") Long groupid, @Param("start") int start,
            @Param("size") int size);
    
    int countKnowledgeId(@Param("userId") long userId, @Param("groupid") Long groupid);
