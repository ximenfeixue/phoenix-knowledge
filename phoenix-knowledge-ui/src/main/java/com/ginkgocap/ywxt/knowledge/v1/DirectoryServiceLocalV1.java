...
import com.ginkgocap.ywxt.knowledge.service.BaseServiceLocal;
...
{
    private Logger logger = LoggerFactory.getLogger(DirectoryServiceLocalV1.class);
    ...
    public InterfaceResult batchCatalogs(KnowledgeServiceV1 knowledgeService,long userId,List<ResItem> directoryItems) throws Exception
    {
    ...
    public InterfaceResult batchCatalogs(KnowledgeServiceV1 knowledgeService,long userId,String requestJson) throws Exception {
