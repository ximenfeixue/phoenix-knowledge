...
{
    private Logger logger = LoggerFactory.getLogger(TagServiceLocalV1.class);
...
//    //End
//
//    public InterfaceResult batchTags(KnowledgeServiceV1 knowledgeService,long userId, List<ResItem> tagItems) throws Exception
//    {
...
//    }
//
//    public InterfaceResult batchTags(KnowledgeServiceV1 knowledgeService,long userId, String requestJson) throws Exception {
